...
$Line1 | ForEach-Object {
  ...
  {
    R {1..$Step | ForEach-Object { $Global:x++; $Global:Canvas."$Global:x,$Global:y" = '1'  }}
    L {1..$Step | ForEach-Object { $Global:x--; $Global:Canvas."$Global:x,$Global:y" = '1'  }}
    U {1..$Step | ForEach-Object { $Global:y++; $Global:canvas."$Global:x,$Global:y" = '1'  }}
    D {1..$Step | ForEach-Object { $Global:y--; $Global:canvas."$Global:x,$Global:y" = '1'  }}
  }
}
...
$Line2 | ForEach-Object {
  ...
  switch (($_).Substring(0,1))
  {
    R {1..$Step | ForEach-Object { $global:x++; if (($Global:Canvas).ContainsKey("$global:x,$global:y")) { if ($Global:canvas."$global:x,$global:y" -eq 1) {$Global:canvas."$global:x,$global:y" = 'X'; $Global:Intersects."$global:x,$global:y" = 'X'} } else {$Global:canvas."$global:x,$global:y" = '2'} }}
    L {1..$Step | ForEach-Object { $global:x--; if (($Global:Canvas).ContainsKey("$global:x,$global:y")) { if ($Global:canvas."$global:x,$global:y" -eq 1) {$Global:canvas."$global:x,$global:y" = 'X'; $Global:Intersects."$global:x,$global:y" = 'X'} } else {$Global:canvas."$global:x,$global:y" = '2'} }}
    U {1..$Step | ForEach-Object { $global:y++; if (($Global:Canvas).ContainsKey("$global:x,$global:y")) { if ($Global:canvas."$global:x,$global:y" -eq 1) {$Global:canvas."$global:x,$global:y" = 'X'; $Global:Intersects."$global:x,$global:y" = 'X'} } else {$Global:canvas."$global:x,$global:y" = '2'} }}
    D {1..$Step | ForEach-Object { $global:y--; if (($Global:Canvas).ContainsKey("$global:x,$global:y")) { if ($Global:canvas."$global:x,$global:y" -eq 1) {$Global:canvas."$global:x,$global:y" = 'X'; $Global:Intersects."$global:x,$global:y" = 'X'} } else {$Global:canvas."$global:x,$global:y" = '2'} }}
  }
}
