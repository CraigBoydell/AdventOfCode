...
$BoardingPassScanResult | where-object {$_.seatID+ 1 -notin $BoardingPassScanResult.SeatID -or $_.seatID-1 -notin $BoardingPassScanResult.SeatID} | sort-object -Property SeatID